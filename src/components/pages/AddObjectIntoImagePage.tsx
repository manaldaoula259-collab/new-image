...
const DEFAULT_RESULT_FILENAME = "add-object-into-image.jpg";
...
const addObjectExamples = [
  {
    id: 1,
    src: "/assets/add-object-into-image/1.png",
    alt: "Add object into image example 1",
  },
  {
    id: 2,
    src: "/assets/add-object-into-image/2.png",
    alt: "Add object into image example 2",
  },
  {
    id: 3,
    src: "/assets/add-object-into-image/3.png",
    alt: "Add object into image example 3",
  },
];

const AddObjectIntoImagePage = () => {
  ...
  const handleConvert = async () => {
    ...
    if (!uploadedImage) {
      toast({
        ...
        description: "Upload an image to add objects into it.",
        status: "warning",
        duration: 3000,
        isClosable: true,
        position: "top-right",
    ...
    if (!objectDescription.trim()) {
      toast({
        ...
        description: "Please describe what object you want to add to the image.",
        status: "warning",
        duration: 3000,
        isClosable: true,
        position: "top-right",
    ...
    try {
      ...
      const response = await fetch("/api/ai-image-editor/add-object-into-image", {
        method: "POST",
        headers: {
  ...
  const handleSaveToLibrary = async () => {
    ...
    try {
      const response = await fetch("/api/media", {
        ...
        body: JSON.stringify({
          url: resultUrl,
          prompt: lastPrompt || "Add object into image",
          source: "add-object-into-image",
        }),
      });
            ...
            >
              ...
              >
                    ...
                    >
                      ...
                      >
                        ...
                        <VStack spacing={4}>
                          ...
                          >
                            <Icon as={BsPlusCircle} fontSize="2xl" color="white" />
                          </Box>
                          <VStack spacing={2}>
                            <Text
                              fontFamily="'General Sans', 'Inter', sans-serif"
                ...
                <VStack spacing={3} width="100%" position="relative" zIndex={1}>
                  <Textarea
                    placeholder="Describe the object to add (e.g., a red car, a golden retriever, a beautiful sunset...)"
                  ...
                  >
                    <Box
                      ...
                      flexShrink={0}
                    >
                      <Icon as={BsPlusCircle} fontSize="xl" color="white" />
                    </Box>
                    <Text px={{ base: 4, md: 6 }} py={{ base: 3, md: 4 }} flex="1" textAlign="left">
                      {isProcessing ? "ADDING OBJECT..." : "ADD OBJECT TO IMAGE"}
                    </Text>
                  </Button>
                </VStack>
              </VStack>
                    ...
                    >
                      <Center flexDirection="column" minH="400px" gap={4}>
                        <Box
                          ...
                          borderColor="rgba(0, 0, 0, 0.2)"
                        >
                          <Icon as={BsPlusCircle} fontSize="2xl" color="rgba(0, 0, 0, 0.4)" />
                        </Box>
                        <VStack spacing={2}>
                          <Text
                            fontFamily="'General Sans', 'Inter', sans-serif"
                          ...
                          <Text
                            ...
                            textAlign="center"
                          >
                            Upload an image and describe the object to add
                          </Text>
                        </VStack>
                      </Center>
                    </MotionBox>
            ...
            >
              ...
              <Box maxW="3xl" mx="auto">
                <Text
                  ...
                  opacity={0.9}
                >
                  Seamlessly add objects, people, and elements into your images with AI precision.
                </Text>
              </Box>
              <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6} width="100%">
                {addObjectExamples.map((example, index) => (
                  <MotionBox
                    key={example.id}
                    borderRadius="16px"
                    overflow="hidden"
...
export default AddObjectIntoImagePage;
