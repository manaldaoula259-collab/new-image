...
const DEFAULT_RESULT_FILENAME = "sketch-to-art.jpg";
...
const sketchToArtExamples = [
  {
    id: 1,
    src: "/example-sketch-architecture.png",
    alt: "Concept art from sketch",
  },
  {
    id: 2,
    src: "/example-sketch-portrait.jpeg",
    alt: "Character illustration from sketch",
  },
  {
    id: 3,
    src: "/example-sketch-landscape.jpeg",
    alt: "Environment painting from sketch",
  },
];

const TurnSketchToArtPage = () => {
  ...
  const handleConvert = async () => {
    ...
    if (!uploadedImage) {
      toast({
        ...
        description: "Upload a sketch or line art to paint over.",
        status: "warning",
        duration: 3000,
        isClosable: true,
        position: "top-right",
    ...
    try {
      ...
      const response = await fetch("/api/ai-photo-filter/turn-sketch-to-art", {
        method: "POST",
        headers: {
      ...
      if (!response.ok) {
        let message = "The painting service returned an unexpected error.";
        try {
      ...
      if (!data?.resultUrl) {
        throw new Error("The painting service did not return a result URL.");
      }
      ...
      toast({
        ...
        description: "Your AI-painted artwork is ready to download.",
        status: "success",
        duration: 3000,
        isClosable: true,
        position: "top-right",
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error("Unable to download the painted artwork.");
      }
      ...
      toast({
        ...
        description: "We opened the painted artwork in a new tab so you can download it manually.",
        status: "info",
        duration: 3000,
        isClosable: true,
        position: "top-right",
  ...
  const handleSaveToLibrary = async () => {
    ...
    try {
      const response = await fetch("/api/media", {
        ...
        body: JSON.stringify({
          url: resultUrl,
          prompt: "AI Sketch to Art - Cinematic painting with lighting, color, and texture",
          source: "turn-sketch-to-art",
        }),
      });
      ...
      <PageContainer pb={16} position="relative" zIndex={2}>
        <Container maxW="1400px" px={{ base: 4, md: 8 }}>
            ...
            >
              ...
              <Box maxW={{ base: "100%", md: "800px" }}>
                <Text
                  ...
                  opacity={0.9}
                >
                  Feed your line art to our AI painter and watch it come alive with cinematic lighting, color, and texture—perfect for concept art, storyboards, and comics.
                </Text>
              </Box>
            </MotionVStack>
          ...
          <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={6} width="100%">
              ...
              >
                    ...
                    >
                      ...
                      >
                        ...
                        <VStack spacing={4}>
                          ...
                          >
                            <Icon as={BsPen} fontSize="2xl" color="white" />
                          </Box>
                          <VStack spacing={2}>
                            <Text
                              fontFamily="'General Sans', 'Inter', sans-serif"
                              ...
                              textAlign="center"
                            >
                              {isDragActive ? "Drop your sketch here" : "Click or drag to upload"}
                            </Text>
                            <Text
                              fontFamily="'General Sans', 'Inter', sans-serif"
                              fontSize="sm"
                ...
                >
                  <Box
                    ...
                    flexShrink={0}
                  >
                    <Icon as={BsPen} fontSize="xl" color="white" />
                  </Box>
                  <Text px={{ base: 4, md: 6 }} py={{ base: 3, md: 4 }} flex="1" textAlign="left">
                    {isProcessing ? "PAINTING..." : "PAINT WITH AI"}
                  </Text>
                </Button>
              </VStack>
            </Box>
                    ...
                    >
                      <Center flexDirection="column" minH="400px" gap={4}>
                        <Box
                          ...
                          borderColor="rgba(0, 0, 0, 0.2)"
                        >
                          <Icon as={BsPen} fontSize="2xl" color="rgba(0, 0, 0, 0.4)" />
                        </Box>
                        <VStack spacing={2}>
                          <Text
                            fontFamily="'General Sans', 'Inter', sans-serif"
                            ...
                            textAlign="center"
                          >
                            Painted artwork will appear here
                          </Text>
                          <Text
                            fontFamily="'General Sans', 'Inter', sans-serif"
                            fontSize="sm"
                            ...
                            textAlign="center"
                          >
                            Upload a sketch to paint it with AI
                          </Text>
                        </VStack>
                      </Center>
                    </MotionBox>
            ...
            {/* Example Painted Transformations Section */}
            <MotionVStack
              spacing={6}
              width="100%"
              pt={8}
            ...
            >
              <Text
                ...
                letterSpacing="-0.6px"
              >
                Example Painted Transformations
              </Text>
              <Box maxW="3xl" mx="auto">
                <Text
                  ...
                  opacity={0.9}
                >
                  Sketch-to-art conversions across concept art, character design, and environment painting.
                </Text>
              </Box>
              <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6} width="100%">
                {sketchToArtExamples.map((example, index) => (
                  <MotionBox
                    key={example.id}
                    borderRadius="16px"
                    overflow="hidden"
                  ...
                  >
                    <Image
                      ...
                      objectFit="cover"
                      borderRadius="16px"
                      fallbackSrc="https://via.placeholder.com/400x400/f0f0f0/999999?text=Art+Example"
                    />
                  </MotionBox>
                ))}
              </SimpleGrid>
...
export default TurnSketchToArtPage;
