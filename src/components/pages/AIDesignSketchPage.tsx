...
const DEFAULT_RESULT_FILENAME = "ai-design-sketch.jpg";
...
// Example sketch images for the bottom section
const exampleSketchImages = [
  {
    id: 1,
    src: "/example-sketch-portrait.jpeg",
    alt: "Portrait sketch example",
    title: "Portrait Sketch",
    description: "Transform photos into artistic portrait sketches",
  },
  {
    id: 2,
    src: "/example-sketch-landscape.jpeg",
    alt: "Landscape sketch example",
    title: "Landscape Sketch",
    description: "Convert landscapes into detailed pencil drawings",
  },
  {
    id: 3,
    src: "/example-sketch-architecture.png",
    alt: "Architecture sketch example",
    title: "Architecture Sketch",
    description: "Turn buildings into architectural line drawings",
  },
  {
    id: 4,
    src: "/example-sketch-object.png",
    alt: "Object sketch example",
    title: "Object Sketch",
    description: "Create detailed sketches of everyday objects",
  },
];

const AIDesignSketchPage = () => {
  ...
  const handleConvert = async () => {
    ...
    if (!uploadedImage) {
      toast({
        ...
        description: "Please upload an image to convert to sketch.",
        status: "warning",
        duration: 3000,
        isClosable: true,
        position: "top-right",
    ...
    try {
      ...
      const response = await fetch("/api/ai-photo-filter/ai-design-sketch", {
        method: "POST",
        headers: {
      ...
      toast({
        title: "Sketch conversion complete!",
        description: "Your AI design sketch is ready for download.",
        status: "success",
        duration: 3000,
        isClosable: true,
        position: "top-right",
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error("Unable to download the generated sketch.");
      }
      ...
      toast({
        ...
        description: "We opened the sketch in a new tab so you can download it manually.",
        status: "info",
        duration: 3000,
        isClosable: true,
        position: "top-right",
  ...
  const handleSaveToLibrary = async () => {
    ...
    try {
      const response = await fetch("/api/media", {
        ...
        body: JSON.stringify({
          url: resultUrl,
          prompt: "AI Design Sketch - Black and white hand-drawn sketch",
          source: "ai-design-sketch",
        }),
      });

      if (!response.ok) {
        let message = "Failed to save sketch to your library.";
        try {
          const errorPayload = await response.json();
          if (errorPayload?.error) {
            message = errorPayload.error;
      ...
      toast({
        ...
        description:
          error instanceof Error
            ? error.message
            : "Unable to save this sketch. Please try again.",
        status: "error",
        duration: 4000,
        isClosable: true,
        position: "top-right",
            ...
            >
              ...
              <Box maxW={{ base: "100%", md: "800px" }}>
                <Text
                  ...
                  opacity={0.9}
                >
                  Transform any photo into beautiful hand-drawn sketches with AI precision—perfect for artistic designs and creative projects.
                </Text>
              </Box>
            </MotionVStack>
              ...
              >
                    ...
                    >
                      ...
                      >
                        ...
                        <VStack spacing={4}>
                          ...
                          >
                            <Icon as={BsPencil} fontSize="2xl" color="white" />
                          </Box>
                          <VStack spacing={2}>
                            <Text
                              fontFamily="'General Sans', 'Inter', sans-serif"
                ...
                >
                  <Box
                    ...
                    flexShrink={0}
                  >
                    <Icon as={BsPencil} fontSize="xl" color="white" />
                  </Box>
                  <Text px={{ base: 4, md: 6 }} py={{ base: 3, md: 4 }} flex="1" textAlign="left">
                    {isProcessing ? "GENERATING..." : "GENERATE SKETCH"}
                  </Text>
                </Button>
              </VStack>
            </Box>
                    ...
                    >
                      <Center flexDirection="column" minH="400px" gap={4}>
                        <Box
                          ...
                          borderColor="rgba(0, 0, 0, 0.2)"
                        >
                          <Icon as={BsPencil} fontSize="2xl" color="rgba(0, 0, 0, 0.4)" />
                        </Box>
                        <VStack spacing={2}>
                          <Text
                            fontFamily="'General Sans', 'Inter', sans-serif"
                          ...
                          <Text
                            ...
                            textAlign="center"
                          >
                            Upload an image to generate a sketch
                          </Text>
                        </VStack>
                      </Center>
                    </MotionBox>
            ...
            >
              ...
              <Box maxW="3xl" mx="auto">
                <Text
                  ...
                  opacity={0.9}
                >
                  See how our AI transforms different types of images into beautiful hand-drawn sketches
                </Text>
              </Box>

              <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6} width="100%">
                {exampleSketchImages.slice(0, 3).map((example, index) => (
                  <MotionBox
                    key={example.id}
                    borderRadius="16px"
                    overflow="hidden"
                  ...
                  >
                    <Box position="relative" sx={{ aspectRatio: 1 }}>
                      <Image
                        ...
                        objectFit="cover"
                        borderRadius="16px"
                        fallbackSrc="https://via.placeholder.com/400x400/f0f0f0/999999?text=Sketch+Example"
                      />
                    </Box>
                  </MotionBox>
                ))}
...
export default AIDesignSketchPage;
