...
const DEFAULT_RESULT_FILENAME = "ai-photo-enhancer.jpg";
...
const photoEnhancerExamples = [
  {
    id: 1,
    src: "/assets/AI-photo-enhancer/1.png",
    alt: "AI photo enhancer example 1",
  },
  {
    id: 2,
    src: "/assets/AI-photo-enhancer/2.png",
    alt: "AI photo enhancer example 2",
  },
  {
    id: 3,
    src: "/assets/AI-photo-enhancer/3.png",
    alt: "AI photo enhancer example 3",
  },
];

const AIPhotoEnhancerPage = () => {
  ...
  const handleConvert = async () => {
    ...
    if (!uploadedImage) {
      toast({
        ...
        description: "Upload an image to enhance it.",
        status: "warning",
        duration: 3000,
        isClosable: true,
        position: "top-right",
    ...
    try {
      ...
      const response = await fetch("/api/ai-image-editor/ai-photo-enhancer", {
        method: "POST",
        headers: {
      ...
      if (!response.ok) {
        let message = "The photo enhancement service returned an unexpected error.";
        try {
      ...
      if (!data?.resultUrl) {
        throw new Error("The photo enhancement service did not return a result URL.");
      }
      ...
      toast({
        ...
        description: "Your enhanced photo is ready to download.",
        status: "success",
        duration: 3000,
        isClosable: true,
        position: "top-right",
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error("Unable to download the enhanced image.");
      }
      ...
      toast({
        ...
        description: "We opened the enhanced image in a new tab so you can download it manually.",
        status: "info",
        duration: 3000,
        isClosable: true,
        position: "top-right",
  ...
  const handleSaveToLibrary = async () => {
    ...
    try {
      const response = await fetch("/api/media", {
        ...
        body: JSON.stringify({
          url: resultUrl,
          prompt: "AI Photo Enhancer - Enhanced photo quality",
          source: "ai-photo-enhancer",
        }),
      });
      if (!response.ok) {
            ...
            >
              ...
              <Box maxW={{ base: "100%", md: "800px" }}>
                <Text
                  ...
                  opacity={0.9}
                >
                  Automatically enhance photo resolution, sharpen details, and improve the quality and aesthetic appeal of your photos.
                </Text>
              </Box>
            </MotionVStack>
          ...
          <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={6} width="100%">
                    ...
                    >
                      ...
                      >
                        ...
                        <VStack spacing={4}>
                          ...
                          >
                            <Icon as={HiSparkles} fontSize="2xl" color="white" />
                          </Box>
                          <VStack spacing={2}>
                            <Text
                              fontFamily="'General Sans', 'Inter', sans-serif"
                    ...
                    >
                      <Center flexDirection="column" minH="400px" gap={4}>
                        <Box
                          ...
                          borderColor="rgba(0, 0, 0, 0.2)"
                        >
                          <Icon as={HiSparkles} fontSize="2xl" color="rgba(0, 0, 0, 0.4)" />
                        </Box>
                        <VStack spacing={2}>
                          <Text
                            fontFamily="'General Sans', 'Inter', sans-serif"
                          ...
                          <Text
                            ...
                            textAlign="center"
                          >
                            Upload and enhance an image to see the result
                          </Text>
                        </VStack>
                      </Center>
                    </MotionBox>
            ...
            >
              <Text
                ...
                letterSpacing="-0.6px"
              >
                Example Photo Enhancement Results
              </Text>
              <Box maxW="3xl" mx="auto">
                <Text
                  ...
                  opacity={0.9}
                >
                  Enhance image quality, sharpness, and clarity with AI-powered photo enhancement.
                </Text>
              </Box>
              <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6} width="100%">
                {photoEnhancerExamples.map((example, index) => (
                  <MotionBox
                    key={example.id}
                    borderRadius="16px"
                    overflow="hidden"
...
export default AIPhotoEnhancerPage;
