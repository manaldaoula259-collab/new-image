...
export const ProjectContext = createContext<{
  ...
  shotTemplate: IShot | undefined;
  updateShotTemplate: (shot: IShot | undefined) => void;
  fetchShots: () => void;
...
export const ProjectProvider = ({
  ...
  const [shotTemplate, setShotTemplate] = useState<IShot>();
  ...
  const { isLoading: isLoadingMore, refetch } = useQuery(
    ...
    () =>
      axios.get<{ shots: IShot[]; shotsCount: number }>(
  ...
  const updateShotTemplate = (shotTemplate: IShot | undefined) => {
